...
export class AUmainNavContent extends React.PureComponent {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      ...
      this.state.closed !== prevState.closed
    ) {
  ...
  toggleClasses(element, state, openingClass, closingClass) {
    ...
    if (state === "opening" || state === "open") {
      oldClass = openingClass || "au-main-nav__content--closed";
  ...
  auFocusTrapListenerTop(event) {
    var focusContent = this.mainNavMenu.querySelectorAll(
      "a, .au-main-nav__toggle"
    );
  ...
  auKeyListener(event) {
    ...
    var overlayOpen = window
      .getComputedStyle(this.mainNavOverlay)
  ...
  mainNavToggle(element, speed, callbacks) {
    ...
    var focustrapBottom = element.querySelector(
      ...
      AU.animate.Toggle({
        ...
        postfunction: function () {
          if (state === "opening") {
            ...
            focustrapBottom.addEventListener(
              "focus",
            ...
            focustrapBottom.removeEventListener(
              "focus",
              AUfocusTrapListenerBottom
            );
    ...
    return (
      ...
      >
        ...
        <div
          aria-controls={this.id}
          ref={(mainNavOverlay) => {
            this.mainNavOverlay = mainNavOverlay;
          }}
          onClick={(event) => this.toggle(event)}
