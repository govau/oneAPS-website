...
import { checkAuth } from "./routes/middleware/checkAuth";
import loginRouter from "./routes/login/login.routes";
import resetPasswordRouter from "./routes/resetPassword/resetPassword.router";
import logoutRouter from "./routes/logout/logout.routes";
